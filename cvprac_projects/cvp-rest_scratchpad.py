...
getid = connect_cvp.getContainerInfoByKey('container_1_522717286731')
pp(getid)

devid = connect_cvp.getNetElementById('0c:89:f7:02:6a:d4')
pp(devid)

mylist = {'Virtual_SL-DC': 'CC772A59908B959E4BD7869640068534'}
map_node_container = connect_cvp.mapDevicesToContainers(mylist)
